require_relative '../lib/data_types/doubly_linked_list/doubly_linked_list'

RSpec.describe DataTypes::DoublyLinkedList do
  let(:list) { DataTypes::DoublyLinkedList.new }
  ...
  describe '#append' do
    ...
    it 'sets the previous pointer correctly' do
      list.append(1)
      list.append(2)

      second_node = list.find(2)
      expect(second_node.previous.value).to eq(1)
    end
  end
  ...
  describe '#prepend' do
    ...
    it 'sets the next and previous pointers correctly' do
      list.append(2)
      list.prepend(1)

      first_node = list.find(1)
      second_node = list.find(2)

      expect(first_node.next.value).to eq(2)
      expect(second_node.previous.value).to eq(1)
    end
  end
  ...
  describe '#reverse_each' do
    it 'iterates over each element in reverse order' do
      list.append(1)
      list.append(2)
      list.append(3)

      result = []
      list.reverse_each { |value| result << value }
